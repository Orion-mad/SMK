...
$nombre_archivo    = $DT['Paciente'].' '.$PRE[0]['nombre_corto'].' '.$DT['PtoVta'].' '.$DT['CbteDesde'];
...
if($DT['IdAlicuota'] == 4):
    $iva = 10.5;
elseif($DT['IdAlicuota'] == 5):
    $iva = 21;
elseif($DT['IdAlicuota'] == 3):
    $iva = 0;
endif;

$parcial    = $DT['ImpNeto']/$unidades;
$v_iva      = $DT['ImpIva'];
$total      = $DT['ImpTotal'];
$ttf        = $DT['ImpTotal'];
...
$pdf->fecha     = $GUSERS->fechaes($DT['CbteFch']);;
